  ...
  const onSave = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn('Cloudinary is not configured. Photo saved locally and Firebase album sync was skipped.');
      }

      if (notifyFriends && !isLocalOnlyPhoto) {
        try {
          ...
          <View style={[styles.previewActions, { backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingVertical: 24 }]}>
            ...
            {locationName && (
              <TouchableOpacity
                ...
                <Ionicons
                  ...
                  size={18}
                  color={includeLocation ? "#FACC15" : "#999"}
                  style={{ marginLeft: 4 }}
                />
              </TouchableOpacity>
            )}
            ...
            <TouchableOpacity
              ...
              <Ionicons
                ...
                size={20}
                color={loading ? "#ccc" : (notifyFriends ? "#FACC15" : "#999")}
              />
